  ...
  <div>
    <a-layout>
      <a-layout-sider width="280">
        <a-card :bordered="false" :style="{height:`calc(${windowHeight}px - 210px)`,overflow:'hidden'}" title="资源组">
          <c-tree
            :loading="loading"
            ref="groupTree"
            :data="loadGroupTree"
      ...
      <a-layout>
        <a-layout-content>
          <a-card :bordered="false" :style="{height:`calc(${windowHeight}px - 210px)`,overflow:'hidden'}" title="资源列表">
