          ...
          <a-row :gutter="48">
            <a-col :md="8" :sm="24">
              <a-form-item label="名称">
                <a-input v-model="queryParam.agName" placeholder="" />
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item label="IP">
                <a-input v-model="queryParam.agIp" placeholder="" />
              </a-form-item>
            </a-col>
...
export default {
  ...
  data() {
    return {
      ...
      record: {},
      loadData: (parameter) => {
        return request.post('/asset-gateway/page', Object.assign(parameter, this.queryParam)).then((res) => {
  ...
  methods: {
    ...
    doDelete: function (param, confirm = true) {
      ...
      if (!confirm) {
        this.loading = true
        request.post('/asset-gateway/delete', param).then(res => {
