...
import { updateTheme, updateColorWeak } from '@ant-design-vue/pro-layout/es/utils/dynamicTheme'
// import { genStringToTheme } from '../../utils/util'
import { genStringToTheme } from '@ant-design-vue/pro-layout/es/utils/util'
import CopyToClipboard from 'vue-copy-to-clipboard'
import store from '@/store'
import { TOGGLE_MULTI_TAB } from '@/store/mutation-types'
...
var SettingDrawer = {
  ...
  render: function render (h) {
    ...
    var theme = _settings$theme === void 0 ? 'dark' : _settings$theme
    var _settings$primaryColo = settings.primaryColor
    var primaryColor = _settings$primaryColo === void 0 ? 'daybreak' : _settings$primaryColo
    var _settings$layout = settings.layout
    var layout = _settings$layout === void 0 ? 'sidemenu' : _settings$layout
    var _settings$fixedHeader = settings.fixedHeader
    var fixedHeader = _settings$fixedHeader === void 0 ? false : _settings$fixedHeader
    var _settings$fixSiderbar = settings.fixSiderbar
    var fixSiderbar = _settings$fixSiderbar === void 0 ? false : _settings$fixSiderbar
    var contentWidth = settings.contentWidth
    var multiTab = settings.multiTab
      ...
      [
        ...
        h(
          ...
          [
            ...
            hideHintAlert && hideCopyButton ? null : h(Divider),
            hideHintAlert
              ? null
              : h(Alert, {
                  attrs: {
