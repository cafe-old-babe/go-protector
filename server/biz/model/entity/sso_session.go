...
type SsoSession struct {
	...
	AssetAccPwd    string      `gorm:"size:32;comment:资产从帐号密码" json:"assetAccPwd" binding:"required"`
	...
	Status         string      `gorm:"size:1;comment:会话状态,0-等待连接,1-已连接,2-连接失败,3-会话结束" json:"status"  binding:"required"`
